...
var AudioList = {
  _$currentItem: jquery__WEBPACK_IMPORTED_MODULE_0___default()(),
  _player: null,
  _isPlayerOn: false,
  ...
  _handlePlayButton: function _handlePlayButton(e) {
    ...
    var $item = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.currentTarget).closest(".audio-list__item");
    ...
    if (this._$currentItem[0] !== $item[0]) {
      ...
      this._player = new howler__WEBPACK_IMPORTED_MODULE_1__.Howl({
        src: [src]
      });
  ...
  init: function init() {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(".audio-list").length === 0) return;
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("click", ".audio-list__button", this._handlePlayButton.bind(this));
  }
};
...
var NavSlider = {
  init: function init() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".nav-slider").each(function () {
      new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find(".swiper")[0], {
        mousewheel: {
          forceToAxis: true
        },
        slidesPerView: "auto",
        navigation: {
          prevEl: jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find(".nav-slider__prev")[0],
          nextEl: jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find(".nav-slider__next")[0]
        }
      });
    });
  }
